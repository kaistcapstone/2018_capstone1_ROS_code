...
//     Mat frame;  //assign a memory to save the images
     ...
     msg.size =contours_r.size(); //adjust the size of message. (*the size of message is varying depending on how many circles are detected)
     msg.img_x.resize(contours_r.size());  //adjust the size of array
     msg.img_y.resize(contours_r.size());  //adjust the size of array
