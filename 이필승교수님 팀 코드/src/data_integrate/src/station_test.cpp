...
#define DXL_MAXIMUM_POSITION_VALUE      3000
...
#define DXL_MAXIMUM_SPEED_VALUE_CW      2024


int main(int argc, char **argv)
{
  ros::init(argc, argv, "station_test");
  ros::NodeHandle n;
  ros::Publisher pub;
  pub = n.advertise<core_msgs::station_msg>("/station_state", 100);
  dynamixel::PortHandler *portHandler = dynamixel::PortHandler::getPortHandler(DEVICENAME);
  dynamixel::PacketHandler *packetHandler = dynamixel::PacketHandler::getPacketHandler(PROTOCOL_VERSION);
  core_msgs::station_msg msg;
  msg.station_state = 0;
  pub.publish(msg);
  int index = 0;
  ...
  cout << "Station Wheel control Test." << endl;
  cout << "First, 3 second turn & stop" << endl;
  ...
  dxl_comm_result1 = packetHandler->write2ByteTxRx(portHandler, DXL_ID1, ADDR_MX_MOVING_SPEED, dxl_velocity_CCW[1], &dxl_error);
  dxl_comm_result2 = packetHandler->write2ByteTxRx(portHandler, DXL_ID2, ADDR_MX_MOVING_SPEED, dxl_velocity_CW[1], &dxl_error);
  dxl_comm_result3 = packetHandler->write2ByteTxRx(portHandler, DXL_ID3, ADDR_MX_MOVING_SPEED, dxl_velocity_CW[1], &dxl_error);
  dxl_comm_result4 = packetHandler->write2ByteTxRx(portHandler, DXL_ID4, ADDR_MX_MOVING_SPEED, dxl_velocity_CCW[1], &dxl_error);

  ros::Duration(1.75).sleep();

  dxl_comm_result1 = packetHandler->write2ByteTxRx(portHandler, DXL_ID1, ADDR_MX_MOVING_SPEED, dxl_velocity_CW[0], &dxl_error);
  dxl_comm_result2 = packetHandler->write2ByteTxRx(portHandler, DXL_ID2, ADDR_MX_MOVING_SPEED, dxl_velocity_CCW[0], &dxl_error);
  dxl_comm_result3 = packetHandler->write2ByteTxRx(portHandler, DXL_ID3, ADDR_MX_MOVING_SPEED, dxl_velocity_CCW[0], &dxl_error);
  dxl_comm_result4 = packetHandler->write2ByteTxRx(portHandler, DXL_ID4, ADDR_MX_MOVING_SPEED, dxl_velocity_CW[0], &dxl_error);

  ros::Duration(1.25).sleep();

  //////////////go back

  dxl_comm_result1 = packetHandler->write2ByteTxRx(portHandler, DXL_ID1, ADDR_MX_MOVING_SPEED, dxl_velocity_CW[1], &dxl_error);
  dxl_comm_result2 = packetHandler->write2ByteTxRx(portHandler, DXL_ID2, ADDR_MX_MOVING_SPEED, dxl_velocity_CCW[1], &dxl_error);
  dxl_comm_result3 = packetHandler->write2ByteTxRx(portHandler, DXL_ID3, ADDR_MX_MOVING_SPEED, dxl_velocity_CCW[1], &dxl_error);
  dxl_comm_result4 = packetHandler->write2ByteTxRx(portHandler, DXL_ID4, ADDR_MX_MOVING_SPEED, dxl_velocity_CW[1], &dxl_error);
